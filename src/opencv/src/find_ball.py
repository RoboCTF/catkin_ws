    ...
    def callback(self,data):
        ...
        if cols > 60 and rows > 60 :
            ...
            for i, keyPoint in enumerate(keypoints):
                ...
                # Detecting Yellow
                if self._threshold[0] == (23, 197, 113):
                    self.blob_point.z = s

                # Dtecting Green    
                if self._threshold[0] == (60, 170, 118):
                    self.blob_point.x = s
...
def main(args):
    yellow_min = (23, 197, 113)
    yellow_max = (35, 255, 203) 
    green_min = (60, 170, 118)
    green_max = (65, 255, 202)          
    ...
    ic_green = BlobDetector(green_min, green_max, blur, params, detection_window)
    ic_yellow = BlobDetector(yellow_min, yellow_max, blur, params, detection_window)
