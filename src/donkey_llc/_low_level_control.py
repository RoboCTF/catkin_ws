...
class DkLowLevelCtrl():
    def __init__(self):
        ...
        rospy.loginfo("> Subscriber to Twist corrrectly initialized")

        #--- Create the Subscirber to ir_death_topic topic
        self.ros_sub_death          = rospy.Subscriber("/ir_death_topic", Bool, callback)
